...
const firebaseConfig = {
  ...
  measurementId: "G-1XF8GNRR9V"
    ...
    var Weeding_FormRef = firebase.database().ref('Weeding_Form');
    ...
    function submitForm(e){
      ...
      var days = getInputVal('days');
    
      // Save message
      saveMessage(name, phone, check_in, check_out, time, days);
    ...
    function saveMessage(name, phone, check_in, check_out, time, days){
      var newMessageRef = Weeding_FormRef.push();
      newMessageRef.set({
        name: name,
        phone:phone,
        check_in:check_in,
